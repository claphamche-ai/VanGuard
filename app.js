// ==========================================
// VANGUARD V1.1.25 - UNIVERSAL ICONSET PATCH
// ==========================================
...
// ... ALL OTHER CTRLS (LawEnforcement, Tools, OverlayMaker, ExcelConverter) APPENDED PERFECTLY
...
const ToolsCtrl = {
    ...
    openUploadForm: function() { 
        ...
        // Dynamically populate icon dropdown for new uploads
